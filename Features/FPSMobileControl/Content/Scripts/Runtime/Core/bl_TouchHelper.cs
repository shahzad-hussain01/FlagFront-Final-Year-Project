...
public class bl_TouchHelper : MonoBehaviour
{
    ...
    public void OnMobileButton(FPSMobileButton mobileButton)
    {
    ...
    public void OnMobileButtonID(int buttonId)
    {
        OnMobileButton((FPSMobileButton)buttonId);
    }
