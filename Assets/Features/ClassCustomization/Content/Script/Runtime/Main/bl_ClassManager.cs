...
public class bl_ClassManager : ScriptableObject
{
    ...
    void GetID()
    {
        ...
        if (bl_DataBase.Instance != null &&
            bl_DataBase.Instance.LocalUser != null &&
            bl_DataBase.Instance.LocalUser.metaData != null &&
            bl_DataBase.Instance.LocalUser.metaData.rawData != null)
        {
        ...
        {
            Debug.LogWarning("bl_DataBase.Instance or LocalUser/metaData/rawData is null. Using local PlayerPrefs data instead.");
        }
#endif
