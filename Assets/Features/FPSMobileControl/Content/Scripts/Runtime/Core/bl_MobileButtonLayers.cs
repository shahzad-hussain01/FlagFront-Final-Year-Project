...
namespace MFPS.Mobile
{
    public class bl_MobileButtonLayers : MonoBehaviour
    {
        ...
        public GameObject leaningButtons;
        ...
        private void Start()
        {
            if (leaningButtons != null)
            {
                // check if the leaning buttons should be active
                var scriptType = Type.GetType("bl_PlayerSideLeaning");
                leaningButtons.SetActive(scriptType != null);
            }          
        }
